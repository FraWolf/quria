...
module.exports = class Quria {
  ...
  GetItem(
    ...
    var requestURL = `${this.config.urls.api}/Destiny2/${membershipType}/Profile/${destinyMembershipId}/Item/${itemInstanceId}/`;
    requestURL +=
      components.length > 0 ? `?components=${components.join(",")}` : "";
    return request(requestURL, "GET", this.config.headers);
  }
  ...
  GetVendors(
    ...
    var requestURL = `${this.config.urls.api}/Destiny2/${membershipType}/Profile/${destinyMembershipId}/Character/${characterId}/Vendors/`;
    requestURL +=
      components.length > 0 ? `?components=${components.join(",")}` : "";
    return request(requestURL, "GET", this.config.headers);
  }
