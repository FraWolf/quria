...
const { formatQueryStrings, parseAuthenticationHeaders } = require("../utils");

module.exports = class Bungie {
  constructor(wrapper) {
  ...
  GetDestinyManifest() {
    return request(
      `${this.wrapper.config.urls.api}/Destiny2/Manifest/`,
      "GET",
  ...
  GetDestinyEntityDefinition(entityType, hashIdentifier) {
    return request(
      `${this.wrapper.config.urls.api}/Destiny2/Manifest/${entityType}/${hashIdentifier}/`,
      "GET",
      this.wrapper.config.headers
    );
  }
